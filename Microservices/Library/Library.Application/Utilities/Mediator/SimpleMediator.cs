...
namespace Library.Application.Utilities.Mediator
{
    public class SimpleMediator : IMediator
    {
        ...
        public async Task<TResponse> Send<TResponse>(IRequest<TResponse> request)
        {
            ...
            return await (Task<TResponse>)method.Invoke(useCase, new object[] { request, CancellationToken.None })!;
        }
        ...
        public async Task Send(IRequest request)
        {
            ...
            MethodInfo method = useCaseType.GetMethod("Handle")!;
            await (Task)method.Invoke(useCase, new object[] { request, CancellationToken.None })!;
        }
    }
}
